...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   $sql = "SELECT id, email , contrasena FROM admin WHERE email=:uname and contrasena=:password";
                           ...
                           <div class="col-md-11">
                              <div class="panel login-box" style="    background: #3d86ed;">
                                 <div class="panel-heading">
                                    ...
                                    <h1 style="color: white;"><strong>Sistema de calificaciones</strong></h1>
                                
                                       <h5 style="color: white;"> <strong>Acceso Administrativo</strong></h5>
                                    </div>
                                 </div>
                                 <div class="panel-body p-20">
                                    <form class="admin-login" action='admin-login.php' method="post">
